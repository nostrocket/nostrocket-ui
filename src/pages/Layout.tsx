...
import { AuthContext, type IAuthContextType } from '../components/AuthProvider'
...
const Layout = (): JSX.Element => {
  ...
  const { isAuthenticated } = useContext(AuthContext) as IAuthContextType
                  ...
                  <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-white px-6 pb-4">
                    <div className="flex h-16 shrink-0 items-center">
                      <img
                        ...
                        src="https://raw.githubusercontent.com/nostrocket/nostrocket.org/master/images/rocket.png"
                        alt="Your Company"
                      />
                    </div>
              ...
              {!isAuthenticated && (
                ...
                >
                  <p>
                    ...
                    >
                      NIP-07 nostr signing browser extension (such as GetAlby or
                      Nos2x)
                    </a>{' '}
                    if you want to interact with Nostrocket!
                  </p>
                </Alert>
              )}
              <Outlet />
